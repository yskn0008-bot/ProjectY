...
EXTRA = (
    ...
    "Do not return an empty actions list for clear calendar, reminder, shopping, task, idea, memo, open_app, device_setting, myway, or shortcut_factory intent. "
    ...
    "Wi-Fiを切って -> executor device_setting, target wifi, content off; ショートカットを作って -> executor shortcut_factory. "
