...
const CACHE_NAME=CACHE_PREFIX+'v4-consult-routing';
const STATIC=[
  ...
  './yos/consult/','./yos/consult/index.html','./yos/consult/styles.css','./yos/consult/app.js',
