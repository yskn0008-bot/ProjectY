...
@media(max-height:720px){main{padding:5px 8px 6px;gap:5px}.head{height:28px;flex-basis:28px}h1{font-size:22px}.status{height:52px;flex-basis:52px;border-radius:15px}.mode{font-size:17px}.fan{font-size:12px}.temp{font-size:27px}.controls{gap:5px}button{font-size:17px;border-radius:16px}}
