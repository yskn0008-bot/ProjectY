...
const files=['YOS Tapo H110 Core.js','YOS BRAVIA Widget.js','YOS Light Widget.js','YOS Light Remote.js','YOS Light Hold Probe.js','YOS AC Probe.js','YOS AC Remote.js','YOS AC Widget.js'];
...
a.message='BRAVIA / エアコン / 照明のウィジェット一式を更新しました。';
a.addAction('OK');
