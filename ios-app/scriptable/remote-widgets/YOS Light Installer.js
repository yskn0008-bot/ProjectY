...
const files=['YOS Tapo H110 Core.js','YOS Light Widget.js'];
...
const a=new Alert();a.title='照明ウィジェット準備完了';a.message='YOS Light Widget を実行して動作確認してください。';a.addAction('OK');await a.presentAlert();
