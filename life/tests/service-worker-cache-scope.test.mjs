...
assert.deepEqual(deleted, ['yos-life-home-v2','yos-life-home-v4'], 'only stale Life caches may be deleted');
...
assert.match(source, /home-priority-v1\.css\?v=1/, 'priority home styles must be available offline');
assert.match(source, /home-v1\.js\?v=2/, 'current home script must be cached with its requested URL');
