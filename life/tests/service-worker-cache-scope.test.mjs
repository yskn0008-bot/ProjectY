...
assert.match(source, /home-v1\.css\?v=6/, 'current home styles must be cached with its requested URL');
assert.match(source, /yos-life-home-v15-visual-pixel-match-density/, 'Visual Pixel Match density cache generation must be active');
