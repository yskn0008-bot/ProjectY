'use strict';
const CACHE='yos-life-home-v21-ui-harmony';
const LIFE_CACHE_PREFIX='yos-life-';
const STATIC=[
  '../yos/ui-theme.js?v=1',
  '../yos/ui-harmony.css?v=1',
  '../yos/ui-harmony.js?v=1',
...
async function inject(response){
  ...
  if(html.includes('id="life-first-paint"'))return new Response(html,{status:response.status,statusText:response.statusText,headers:response.headers});
