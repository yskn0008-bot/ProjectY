'use strict';
const CACHE='yos-life-home-v9-deadline-state';
...
const STATIC=[
  ...
  './home-v1.js?v=5',
  './home-v1.css?v=2',
  './home-priority-v1.css?v=3'
];
async function inject(response){
  let html=await response.text();
  if(!html.includes('yos-suite-v3.js'))html=html.replace('</body>','<script src="./yos-suite-v3.js?v=7"></script></body>');
