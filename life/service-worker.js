'use strict';
const CACHE='yos-life-home-v21-no-legacy-flash';
...
async function inject(response){
  ...
  if(!html.includes('life-preinstall-guard'))html=html.replace('</head>','<style id="life-preinstall-guard">main.app,.bottom-nav{visibility:hidden!important}</style><link id="lifeHomeV1Styles" rel="stylesheet" href="./home-v1.css?v=7"><link id="lifeHomePriorityV1Styles" rel="stylesheet" href="./home-priority-v1.css?v=4"><link rel="stylesheet" href="./readability-final.css?v=2"></head>');
  ...
  if(!html.includes('yos-suite-v3.js'))html=html.replace('</body>','<script src="./yos-suite-v3.js?v=9"></script></body>');
  if(!html.includes('task-quick-add-v1.js'))html=html.replace('</body>','<script src="./task-quick-add-v1.js?v=1"></script></body>');
