...
try{
  ...
  assert.ok(firstFoldGeometry.bottomGap>=0&&firstFoldGeometry.bottomGap<=24,`YOS DESK first screen gap must be 0..24px: gap=${firstFoldGeometry.bottomGap}, pinBottom=${firstFoldGeometry.pinBottom}, appBottom=${firstFoldGeometry.appBottom}`);
