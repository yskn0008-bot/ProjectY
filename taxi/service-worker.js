'use strict';
const CACHE='yos-taxi-projecty-v86-week-value-only';
const VERSION='86';
const STATIC=[
  ...
  './week-money-fit-v68.css','./week-money-fit-v68.js','./week-nav-fit-v79.css','./week-nav-fit-v79.js','./week-date-sales-v82.css','./week-date-sales-v82.js','./week-value-only-v86.css',
...
async function inject(response,type){
  ...
  if(type==='calendar'){
    ['month-grid-fit-v67.css','month-row-fit-v80.css','week-money-fit-v68.css','week-nav-fit-v79.css','week-date-sales-v82.css','week-value-only-v86.css','manage-stable-v77.css','manage-nav-fit-v78.css','manage-card-grow-v81.css'].forEach(addCss);
  }
