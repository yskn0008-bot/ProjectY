...
async function inject(response,type){
  ...
  if(type==='calendar'){
    if(!html.includes('calendar-v2.js'))html=html.replace('</body>','<script src="./calendar-v2.js?v=16"></script></body>');
    if(!html.includes('v15.js'))html=html.replace('</body>','<script src="./v15.js?v=16"></script></body>');
    if(!html.includes('calendar-v3.js'))html=html.replace('</body>','<script src="./calendar-v3.js?v=16"></script></body>');
    if(!html.includes('swipe-nav.js'))html=html.replace('</body>','<script src="./swipe-nav.js"></script></body>');
  }
