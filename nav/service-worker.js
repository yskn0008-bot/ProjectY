'use strict';
const CACHE='yos-navi-strategy-v5';
const STATIC=['./','./index.html','./manifest.webmanifest','./shift-phase-v1.js','./location-status-v1.js','./area-map-v1.js','./map-collapse-v1.js'];
