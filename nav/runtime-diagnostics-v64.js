'use strict';
(()=>{
  if(window.__yosNavRuntimeDiagnosticsV92)return;
  window.__yosNavRuntimeDiagnosticsV92=true;

  const BUILD='v92';
  const EXPECTED_CACHE='yos-navi-strategy-v92-atomic-runtime-cache';
