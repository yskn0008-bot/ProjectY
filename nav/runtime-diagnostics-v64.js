'use strict';
(()=>{
  if(window.__yosNavRuntimeDiagnosticsV91)return;
  window.__yosNavRuntimeDiagnosticsV91=true;

  const BUILD='v91';
  const EXPECTED_CACHE='yos-navi-strategy-v91-preserved-navigation-headers';
