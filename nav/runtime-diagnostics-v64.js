'use strict';
(()=>{
  if(window.__yosNavRuntimeDiagnosticsV85)return;
  window.__yosNavRuntimeDiagnosticsV85=true;

  const BUILD='v85';
  const EXPECTED_CACHE='yos-navi-strategy-v85-critical-direct-scripts';
