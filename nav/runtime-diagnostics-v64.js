'use strict';
(()=>{
  if(window.__yosNavRuntimeDiagnosticsV77)return;
  window.__yosNavRuntimeDiagnosticsV77=true;

  const BUILD='v77';
  const EXPECTED_CACHE='yos-navi-strategy-v77-content-type-validation';
