'use strict';
(()=>{
  if(window.__yosNavRuntimeDiagnosticsV90)return;
  window.__yosNavRuntimeDiagnosticsV90=true;

  const BUILD='v90';
  const EXPECTED_CACHE='yos-navi-strategy-v90-verified-script-injection';
