'use strict';
(()=>{
  if(window.__yosNavRuntimeDiagnosticsV83)return;
  window.__yosNavRuntimeDiagnosticsV83=true;

  const BUILD='v83';
  const EXPECTED_CACHE='yos-navi-strategy-v83-response-url-validation';
