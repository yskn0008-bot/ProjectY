'use strict';
(()=>{
  if(window.__yosNavRuntimeDiagnosticsV100)return;
  window.__yosNavRuntimeDiagnosticsV100=true;

  const BUILD='v100';
  const EXPECTED_CACHE='yos-navi-strategy-v100-older-cache-only-fallback';
