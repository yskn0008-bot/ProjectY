'use strict';
(()=>{
  if(window.__yosNavRuntimeDiagnosticsV89)return;
  window.__yosNavRuntimeDiagnosticsV89=true;

  const BUILD='v89';
  const EXPECTED_CACHE='yos-navi-strategy-v89-canonical-navigation';
